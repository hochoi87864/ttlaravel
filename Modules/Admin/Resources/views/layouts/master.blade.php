  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('admin.dashboard')}}">
        ...
        <div class="sidebar-brand-text mx-3">Admin System <sup>2</sup></div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('admin.get.create.category')}}">Thêm</a>
          </div>
        </div>
      </li>
      <!-- ------ -->
      ...
      <li class="nav-item">
        ...
        <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="{{Route('admin.get.list.product')}}">Danh sách</a>
            <a class="collapse-item" href="{{Route('admin.get.create.product')}}">Thêm</a>
          </div>
        </div>
      </li>
      <!-- ---------- -->
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseSeven" aria-expanded="true" aria-controls="collapseFive">
          <i class="fas fa-american-sign-language-interpreting"></i>
          <span>Đánh giá</span>
        </a>
        <div id="collapseSeven" class="collapse" aria-labelledby="headingFive" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="{{route('admin.get.list.rating')}}">Danh sách</a>
          </div>
        </div>
      </li>
      <!-- ------- -->
      <li class="nav-item">
        ...
        <div id="collapseFor" class="collapse" aria-labelledby="headingFor" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="{{Route('admin.get.list.article')}}">Danh sách</a>
            <a class="collapse-item" href="{{Route('admin.get.create.article')}}">Thêm</a>
          </div>
        </div>
      </li>
      <!-- ---------- -->
      <li class="nav-item">
        ...
        <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="{{route('admin.get.list.transaction')}}">Danh sách</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseSix" class="collapse" aria-labelledby="headingFive" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="{{route('admin.get.list.user')}}">Danh sách</a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content" style="color:black">
        ...
        <!-- Topbar -->
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow" style="height: 2.375rem;">
  ...
  <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">Với "Đồng ý" bạn sẽ thoát tài khoản này. Bạn đồng ý chứ ?</div>
        <div class="modal-footer">
          <button class="btn btn-secondary" type="button" data-dismiss="modal">Không nhé !</button>
          <a class="btn btn-primary" href="{{route('admin.logout')}}">OK !! Đồng ý ạ. </a>
        </div>
      </div>
    </div>
  </div>
